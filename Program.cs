...
namespace SyntheseImage
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Light light2 = new Light(new Vector3(100, 250, 500), new Vector3(50000, 50000, 50000));
            ...
            //for (int i = 0; i < 100; i++)
            //{
            //    Sphere s = new Sphere(new Vector3(random.Next(200, 900), random.Next(200, 600), random.Next(300, 800)), random.Next(10, 50), new Material(Materials.Difuse, Material.White));
            //    scene.shapes.Add(s);
            //}
