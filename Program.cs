...
namespace SyntheseImage
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Sphere test = new Sphere(new Vector3(500, 500, 200), 100, new Material(Materials.Difuse, Material.Blue));
            //scene.shapes.Add(test);

            ////Shape[] shapes = { t1, t2,t3,t4,t5,t6,t7,t8,t9,t10,t11,t12,
            ...
            //string[] lines = System.IO.File.ReadAllLines(@"C:\Users\Guill\Documents\Gamagora\SyntheseImage\SyntheseImage\test.stl");
            ...
            Rayon ray = new Rayon(new Vector3(-1, 0, 0), new Vector3(0, -1, 0));
            Box box = new Box(new Vector3(-10, -10, -10), new Vector3(10,10,10));
            Console.WriteLine(ray.IntersectABox(box));
            Console.ReadLine();
