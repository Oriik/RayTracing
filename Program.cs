...
namespace SyntheseImage
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Light light = new Light(new Vector3(200, 600, 150), new Vector3(5000000, 5000000, 5000000));

            Sphere s1 = new Sphere(new Vector3(1050, 500, 800), 100,
                 new Material(Materials.Mirror, new Vector3(1f, 0.8f, 1f)));
            Sphere s2 = new Sphere(new Vector3(200, 200, 300), 100,
                new Material(Materials.Difuse, new Vector3(1f, 0.8f, 1f)));            
            ...
            Sphere backWall = new Sphere(new Vector3(640, 360, (float)1e5  +1100), (float)1e5,
                new Material(Materials.Difuse, new Vector3(0.2f, 1f, 0.2f))); //MIROIR BLANC
            Sphere frontWall = new Sphere(new Vector3(640, 360, (float)-1e5 -1), (float)1e5, 
